						...
						rows: [{
							...
							columns: [{
								...
								widgets: [{
									...
									style: 'padding:10px;',
									config: {
										html: '<img width="100%" src="images/dashboards/ethiopia/contact_christophe_bois.png"></img>'
									}
								}]
							},{
								styleClass: 's12 m12 l4',
								...
								widgets: [{
									...
									style: 'padding:10px;',
									config: {
										html: '<img width="100%" src="images/dashboards/ethiopia/contact_olivier_cheminat.png"></img>'
									}
								}]
							}]
						},{
							columns: [{
								...
								widgets: [{
									...
									style: 'padding:10px;',
									config: {
										html: '<img width="100%" src="images/dashboards/ethiopia/contact_haroun_habib.png"></img>'
									}
								}]
							},{
								styleClass: 's12 m12 l4',
								widgets: [{
									...
									style: 'padding:10px;',
									config: {
										html: '<img width="100%" src="images/dashboards/ethiopia/contact_olivier_papadakis.png"></img>'
									}
								}]
							},{
								styleClass: 's12 m12 l4',
								widgets: [{
									...
									style: 'padding:10px;',
									config: {
										html: '<img width="100%" src="images/dashboards/ethiopia/contact_beatrice_muraguri.png"></img>'
									}
								}]
							}]
						},{
