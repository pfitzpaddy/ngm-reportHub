  ...
  .controller( 'ClusterProjectFormReportCtrl', [
    ...
    function( 
      ...
      $scope.project = {
        ...
        // canEdit: ngmAuth.canEditPlain('EDIT', config.project.adminRpcode, config.project.admin0pcode, config.project.cluster_id, config.project.organization_tag),
        // canEdit: ngmAuth.canEdit('EDIT',  config.report),
