      ...
      $scope.project = {
        ...
        /**** ACTIVITIES ****/
				...
				fsacAssessmentPercentage:function (b) {
					...
					if (total > 100 || total_pmd > 100 || isNaN(total) || isNaN(total_pmd)) {
						$scope.fsac_assessment_overflow = true;
					}
					if (total > 100 || total_pmd > 100 ||
						(b.hh_acceptable < 0 || b.hh_borderline < 0 || b.hh_poor < 0 || b.hh_acceptable_pmd < 0 || b.hh_borderline_pmd < 0 || b.hh_poor_pmd < 0) ||
						(b.hh_acceptable === undefined || b.hh_borderline === undefined || b.hh_poor === undefined || b.hh_acceptable_pmd === undefined || b.hh_borderline_pmd === undefined || b.hh_poor_pmd === undefined)) {
						$scope.fsac_assessment_disabled = true;
					}
