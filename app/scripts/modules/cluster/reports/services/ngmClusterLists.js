                        ...
                        var ngmClusterLists = {
                            ...
                            setLists: function (project, transfers) {
                                ...
                                return {
                                    ...
                                    // NG cholera
//          activity_cholera_response: [{ activity_cholera_response_id: 'yes', activity_cholera_response_name: 'Yes' },{ activity_cholera_response_id: 'no', activity_cholera_response_name: 'No' }],
          activity_cholera_response: [{ activity_cholera_response_id: 'completed', activity_cholera_response_name: 'Completed' },{ activity_cholera_response_id: 'planned', activity_cholera_response_name: 'Planned' }],
//                                   
                            ...
                            getStrategicObjectives: function (admin0pcode, start_report_year, end_report_year) {
                                ...
                                for (var i = start_report_year; i <= end_report_year; i++) {
                                    if (strategic_objectives && strategic_objectives[i])
                                        sub_strategic_objectives[i] = strategic_objectives[i];
                                }
