						...
						rows: [{
							...
							columns: [{
								...
								widgets: [{
									...
									style: 'padding:0px;',
									config: {
										html: $scope.dashboard.getServiceHtml( 'dashboards/who-immap/report3.png', 'Data collection, databases and reporting SYSTEMS')
									}
								}]
							},{
								styleClass: 's12 m12 l4',
								widgets: [{
									...
									style: 'padding:0px;',
									config: {
										html: $scope.dashboard.getServiceHtml( 'dashboards/who-immap/data_viz.jpg', 'Mapping, analysis, visualization and INFOGRAPHICS')
									}
								}]
							},{
								styleClass: 's12 m12 l4',
								widgets: [{
									...
									style: 'padding:0px;',
									config: {
										html: $scope.dashboard.getServiceHtml( 'dashboards/who-immap/map.jpg', 'Training, capacity building and change MANAGEMENT')
									}
								}]
							}]
						},{
							columns: [{
								...
								widgets: [{
									...
									style: 'padding:10px;',
									config: {
										html: '<img width="100%" src="images/dashboards/who-immap/contact_abdon.png"></img>'
									}
								}]
							},{
								styleClass: 's12 m12 l4',
