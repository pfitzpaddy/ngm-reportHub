				...
				$scope.model = {
					...
					header: {
						...
						title: {
							...
							title: ngmUser.get().adminRname + ' | ' + ngmUser.get().admin0name.toUpperCase().substring(0, 3) + ' | ' + $scope.report.project.organization + ' | ' + $scope.report.project.project_title // + ' | ' + moment( $scope.report.definition.reporting_period ).format('MMMM, YYYY')
						},
						subtitle: {
