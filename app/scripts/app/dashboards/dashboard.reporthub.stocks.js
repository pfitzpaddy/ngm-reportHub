/**
 * @ngdoc function
 * @name ngmReportHubApp.controller:DashboardReportHubStocksCtrl
 * @description
 * # LoginCtrl
 * Controller of the ngmReportHub
 */
angular.module('ngmReportHub')
	.controller('DashboardReportHubStocksCtrl', [
			'$scope', 
			'$q', 
			'$http', 
			'$location', 
		...
		function ( $scope, $q, $http, $location, $route, $rootScope, $window, $timeout, $filter, ngmUser, ngmAuth, ngmData,$translate ) {
			...
			$scope.dashboard = {
				...
				setDashboard: function(){
					...
					// title
					$scope.dashboard.title = 'REPORTHUB | METRICS | STOCK REPORTING';
					$scope.dashboard.subtitle = 'Results of ReportHub STOCK reporting since JANUARY 1, 2017';
					// report name ( export )
						...
						rows: [{
							columns: [{
								...
								widgets: [{
									...
									card: 'card-panel stats-card white grey-text text-darken-2',
									config: {
										title: 'Stock Reports ( Monthly ) Completed',
										data: { value: 123 }
									}
								}]
							}]
							...
							columns: [{
								...
								widgets: [{
									...
									card: 'card-panel stats-card white grey-text text-darken-2',
									config: {
										title: 'Beneficiaries Can Be Covered With Available Stock',
										data: { value: 2950379 }
									}
								}]
							}]
